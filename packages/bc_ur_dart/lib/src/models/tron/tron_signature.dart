...
class TronSignature extends GsSignature {
  ...
  static TronSignature fromUR(UR ur) {
    if (ur.type.toLowerCase() != RegistryType.TRON_SIGNATURE.type) {
      throw InvalidTypeURException(expected: RegistryType.TRON_SIGNATURE.type, actual: ur.type);
    }
