class RegistryType {
  ...
  static const RegistryType CRYPTO_TXENTITY = RegistryType("crypto-txentity", 6112);

  // RegistryType 补充
  static const RegistryType ETH_SIGN_REQUEST = RegistryType('eth-sign-request', 401);
  static const RegistryType ETH_SIGNATURE = RegistryType('eth-signature', 402);

  static const RegistryType PSBT_SIGN_REQUEST = RegistryType('psbt-sign-request', 501);
  static const RegistryType PSBT_SIGNATURE = RegistryType('psbt-signature', 502);

  static const RegistryType BTC_SIGN_REQUEST = RegistryType('btc-sign-request', 601);
  static const RegistryType BTC_SIGNATURE = RegistryType('btc-signature', 602);

  static const RegistryType KEYSTONE_SIGN_REQUEST = RegistryType('keystone-sign-request', 6101);
  static const RegistryType KEYSTONE_SIGNATURE = RegistryType('keystone-sign-result', 6102);

  static const RegistryType SOL_SIGN_REQUEST = RegistryType("sol-sign-request", 1101);
  ...
  static const RegistryType COSMOS_SIGN_REQUEST = RegistryType("cosmos-sign-request", 1201);
