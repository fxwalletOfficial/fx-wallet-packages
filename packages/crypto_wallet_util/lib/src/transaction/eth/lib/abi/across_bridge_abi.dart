const acrossBridgeAbi = [
  {
    "inputs": [
      ...
      {"internalType": "uint32", "name": "_oftDstEid", "type": "uint32"},
      {"internalType": "uint256", "name": "_oftFeeCap", "type": "uint256"}
    ],
  ...
  {"inputs": [], "name": "OFTFeeUnderpaid", "type": "error"},
  {"inputs": [], "name": "OFTTokenMismatch", "type": "error"},
  {"inputs": [], "name": "OftFeeCapExceeded", "type": "error"},
  {"inputs": [], "name": "OftIncorrectAmountReceivedLD", "type": "error"},
  {"inputs": [], "name": "OftIncorrectAmountSentLD", "type": "error"},
  {"inputs": [], "name": "OftInsufficientBalanceForFee", "type": "error"},
  {"inputs": [], "name": "OftLzFeeNotZero", "type": "error"},
  ...
  },
  {
    ...
    "name": "oftMessengers",
    "outputs": [
      {"internalType": "address", "name": "l2OftMessenger", "type": "address"}
    ],
    "stateMutability": "view",
    "type": "function"
  },
