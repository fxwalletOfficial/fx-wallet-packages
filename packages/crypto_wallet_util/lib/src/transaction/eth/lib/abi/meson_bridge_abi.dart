const mesonBridgeAbi = [
  ...
  },
  {
    "inputs": [
      ...
      {"internalType": "uint8[]", "name": "indexes", "type": "uint8[]"}
    ],
    "name": "addMultipleSupportedTokens",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
  ...
  },
  {
    "inputs": [
      ...
      {"internalType": "uint40", "name": "toPoolIndex", "type": "uint40"}
    ],
    "name": "adjustToPool",
    "outputs": [],
    "stateMutability": "nonpayable",
  ...
  },
  {
    "inputs": [
      ...
      {"internalType": "uint40", "name": "poolIndex", "type": "uint40"}
    ],
    "name": "bondSwap",
    "outputs": [],
    "stateMutability": "nonpayable",
  ...
  },
  {
    "inputs": [
      {"internalType": "uint256", "name": "amount", "type": "uint256"},
      {"internalType": "uint48", "name": "poolTokenIndex", "type": "uint48"}
    ],
    "name": "deposit",
    "outputs": [],
  ...
  },
  {
    "inputs": [
      ...
      {"internalType": "bytes32", "name": "yParityAndS", "type": "bytes32"},
  ...
  },
  {
    "inputs": [
      ...
      {"internalType": "bytes32", "name": "yParityAndS", "type": "bytes32"},
      {"internalType": "address", "name": "recipient", "type": "address"},
      {"internalType": "bool", "name": "depositToPool", "type": "bool"}
    ],
    "name": "executeSwap",
    "outputs": [],
    "stateMutability": "nonpayable",
  ...
  },
  {
    ...
    "outputs": [
      {"internalType": "bytes2", "name": "", "type": "bytes2"}
    ],
    "stateMutability": "pure",
    "type": "function"
  },
  ...
  },
  {
    "inputs": [
      ...
      {"internalType": "address", "name": "premiumManager", "type": "address"}
    ],
    "name": "initialize",
    "outputs": [],
    "stateMutability": "nonpayable",
