...
void main() {
  test('test hns sign', () async {
    ...
    final txSignOne = FxHnsSign(mtx: info, mnemonic: mnemonic).signAnyOne(0);
    expect(txSignOne,
        'e9acd5f84f17eb0c19e47241b5cc93c5fa8ca2c20885b8cd8fba79b3cc2929cd4cf3f4b91eb1e03e0c0ac1ad5c9e183b7304165a7476da0e54e2d1b9e95bec1d84');
  });
}
