...
Future<PermissionResponse?> DEFAULT_PERMISSION_REQUEST(
    ...
    PermissionResponse(
        resources: request.resources, action: PermissionResponseAction.DENY);
...
/// Default EIP-6963 `rdns` (reverse-DNS) identifier announced for the EVM
/// provider when the host app doesn't supply `Web3EthSettings.rdns`. Apps
/// should override this with their own reverse domain.
const String WALLET_RDNS = 'io.web3wallet';
