...
class EIP712TypedData {
  ...
  factory EIP712TypedData.fromJson(Map<String, dynamic> json) => EIP712TypedData(
    name: json['name'] as String,
    type: json['type'] as String,
    value: json['value']
  );

  Map<String, dynamic> toJson() => <String, dynamic>{'name': name, 'type': type, 'value': value};
}
...
class TypedDataField {
  ...
  factory TypedDataField.fromJson(Map<String, dynamic> json) => TypedDataField(name: json['name'] as String, type: json['type'] as String);

  Map<String, dynamic> toJson() => <String, dynamic>{'name': name, 'type': type};
}
