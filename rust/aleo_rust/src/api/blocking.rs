...
mod tests {
    ...
    fn test_api_get_blocks() {
        let client = AleoAPIClient::<CurrentNetwork>::testnet3();
    ...
    fn test_import_resolution() {
        ...
        let id1 = ProgramID::<CurrentNetwork>::from_str("multiply_test.aleo").unwrap();
        let id2 = ProgramID::<CurrentNetwork>::from_str("double_test.aleo").unwrap();
        let id3 = ProgramID::<CurrentNetwork>::from_str("addition_test.aleo").unwrap();
