...
mod tests {
    ...
    fn test_constructors_fail_with_multiple_keys_or_no_keys() {
        ...
        let private_key_ciphertext =
            Encryptor::<MainnetV0>::encrypt_private_key_with_secret(&private_key, "password")
                .unwrap();
    ...
    fn test_program_management_methods() {
        ...
        let mut program_manager =
            ProgramManager::<MainnetV0>::new(Some(private_key), None, None, None, false).unwrap();
    ...
    fn test_import_resolution() {
        ...
        let vm_execute =
            ProgramManager::<MainnetV0>::initialize_vm(&api_client, &top_level_program, true)
                .unwrap();
        let vm_deploy =
            ProgramManager::<MainnetV0>::initialize_vm(&api_client, &top_level_program, false)
                .unwrap();
